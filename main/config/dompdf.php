...
return [
    ...
    */
    ...
    'options' => [
        ...
        /**
         * @var string|null $log_output_file
         */
         ...
         * below.
         *
         * The GD rendering backend is a little different from PDFLib and
         ...
         *
         * @var string $default_paper_orientation
         */
         ...
         *  these settings without understanding the consequences. Additional
         *  documentation is available on the dompdf wiki at:
         *  https://github.com/dompdf/dompdf/wiki
         *
         * @var bool $enable_remote
         */
        'enable_remote' => true,
