...
class AutomatedGatewayController extends Controller
{
    function index()
    {
        $this->authorize('viewAutomatedGateways', Gateway::class);
    ...
    function edit($alias)
    {
        $gateway = Gateway::with(['currencies', 'currencies.method'])
            ->automated()
            ->where('alias', $alias)
            ->firstOrFail();

        $this->authorize('editAutomatedGateway', $gateway);
    ...
    function update($code)
    {
        ...
        $this->authorize('updateAutomatedGateway', $gateway);
    ...
    function remove($id)
    {
        $this->authorize('removeAutomatedGatewayCurrency', Gateway::class);
    ...
    function status($id)
    {
        $this->authorize('changeAutomatedGatewayStatus', Gateway::class);
