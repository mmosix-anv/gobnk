...
<html lang="en">
    ...
    <body class="pt-0">
        ...
        <div class="error">
            <div class="error-page bg-img" data-background-image="{{ asset('assets/universal/images/error-page-bg.png') }}">
                 <div class="container">
                      <div class="row justify-content-center">
                           <div class="col-lg-6">
                                <div class="error-page__content">
                                     <div class="error-page__thumb bg-img" data-background-image="{{ asset('assets/universal/images/error-bg.png') }}">
                                          <h1 class="error-page__thumb__number">419</h1>
                                          <img src="{{ asset('assets/universal/images/error.png') }}" alt="image">
                                     </div>
                                     <div class="error-page__txt">
                                          <h3 class="error-page__txt__title">419, @lang('Sorry! Your Session Has Expired ') 😞</h3>
                                          <p class="error-page__txt__desc">@lang('Oops')! 😖 @lang('Please go back and refresh your browser and try again').</p>
