                           ...
                           <div class="col-lg-6">
                                <div class="error-page__content">
                                     <div class="error-page__thumb bg-img" data-background-image="{{ asset('assets/universal/images/error-bg.png') }}">
                                          <h1 class="error-page__thumb__number">429</h1>
                                          <img src="{{ asset('assets/universal/images/error.png') }}" alt="image">
                                     </div>
                                     <div class="error-page__txt">
                                          <h3 class="error-page__txt__title">429, @lang('Too Many Requests') 😞</h3>
                                          <p class="error-page__txt__desc">@lang('Oops')! 😖 @lang('You have made too many requests in a short period of time').</p>
