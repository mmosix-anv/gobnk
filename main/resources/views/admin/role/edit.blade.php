                        ...
                        <div class="row g-3">
                            ...
                            @foreach($groupedPermissions as $permission)
                                <div class="col-lg-3">
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="form-check form--switch">
                                            <input type="checkbox" class="form-check-input permission-checkbox" name="permissions[]" value="{{ $permission->id }}" data-module="{{ $module }}" @checked(in_array($permission->id, old('permissions', $hasPermissions)))>
                                        </div>
