...
@section('master')
    <div class="col-12">
        <form action="{{ route('admin.loan.plans.store') }}" method="post" class="row g-4">
            @csrf
            <div class="col-12">
                        ...
                        <div class="row g-lg-4 g-3">
                            ...
                            <div class="col-xl-3 col-sm-6">
                                ...
                                <div class="input--group">
                                    <input type="text" class="form--control iconPicker" name="icon" value="{{ old('icon') }}" required autocomplete="off">
                                    <span class="input-group-text input-group-addon">
                                        @php if (old('icon')) echo old('icon') @endphp
                                    </span>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-4 col-sm-6">
                                ...
                                <div class="input--group">
                                    <input type="number" step="any" min="0" class="form--control" name="minimum_amount" value="{{ old('minimum_amount') }}" required>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6">
                                ...
                                <div class="input--group">
                                    <input type="number" step="any" min="0" class="form--control" name="maximum_amount" value="{{ old('maximum_amount') }}" required>
                                    <span class="input-group-text">{{ $setting->site_cur }}</span>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-4 col-sm-6">
                                ...
                                <div class="input--group">
                                    <input type="number" step="any" min="0" class="form--control" id="installmentRate" name="installment_rate" value="{{ old('installment_rate') }}" required>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6">
                                ...
                                <div class="input--group">
                                    <input type="number" min="0" class="form--control" name="installment_interval" value="{{ old('installment_interval') }}" required>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6">
                                ...
                                <div class="input--group">
                                    <input type="number" min="0" class="form--control" id="totalInstallments" name="total_installments" value="{{ old('total_installments') }}" required>
                    ...
                    <div class="card-body">
                        <div class="row g-lg-4 g-3">
                            <div class="col-lg-4 col-sm-6">
                                ...
                                <div class="input--group">
                                    <input type="number" min="0" class="form--control" name="delay_duration" value="{{ old('delay_duration') }}" required>
                                    <span class="input-group-text">@lang('Days')</span>
                                </div>
                            </div>
                            <div class="col-lg-4 col-sm-6">
