                    ...
                    <div class="card-body">
                        <div class="profile-card">
                            ...
                            <div class="profile-card__txt">
                                ...
                                <span class="badge badge--secondary">{{ $admin->roles->pluck('name')->map(fn($name) => __($name))->implode(', ') }}</span>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row g-lg-4 g-3">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <input type="text" class="form--control" name="username" value="{{ $admin->username }}" required @readonly(!$admin->hasRole('Super Admin'))>
                                        </div>
                                        <div class="col-lg-6">
                                            <label class="form--label required">@lang('Email')</label>
                                            <input type="email" class="form--control" name="email" value="{{ $admin->email }}" required @readonly(!$admin->hasRole('Super Admin'))>
                                        </div>
                                        <div class="col-lg-6">
