                                    ...
                                    <div class="row align-items-center gy-2">
                                        ...
                                        <div class="col-xxl-9">
                                            <div class="input--group">
                                                ...
                                                <span class="input-group-text currencySymbol">{{ isset($methodRelation) ? $methodRelation->currency : '' }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-12">
                    <div class="custom--card">
                        ...
                        <div class="card-body editor-wrapper">
                            <textarea class="form--control trumEdit" name="guideline">{{ $method ? $method->guideline : '' }}</textarea>
                        </div>
                    </div>
                </div>
