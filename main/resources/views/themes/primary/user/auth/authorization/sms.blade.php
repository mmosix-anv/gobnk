...
@section('content')
    <section class="account">
        <div class="account__bg bg-img" data-background-image="{{ getImage($activeThemeTrue . 'images/site/mobile_confirm/' . $mobileConfirmContent->data_info->first_background_image, '960x1080') }}"></div>
        <div class="account__thumb">
            <img src="{{ getImage($activeThemeTrue . 'images/site/mobile_confirm/' . $mobileConfirmContent->data_info->image, '635x485') }}" alt="mobile confirm">
        </div>
        <div class="account__form">
            <div class="account__form__bg bg-img" data-background-image="{{ getImage($activeThemeTrue . 'images/site/mobile_confirm/' . $mobileConfirmContent->data_info->second_background_image, '1080x1080') }}"></div>
