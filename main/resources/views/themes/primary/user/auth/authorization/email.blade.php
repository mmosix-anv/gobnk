...
@php
    $formAction = $verificationRoute ?? route('user.verify.email');
    $resendAction = $resendRoute ?? route('user.send.verify.code', 'email');
    $resendText = $resendMessage ?? 'Please check including your spam folder. If not found, then you can';
@endphp
